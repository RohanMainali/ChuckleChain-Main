                  ...
                  <div className="rounded-lg border p-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Received 10,000 likes across all posts
                        </p>
                      </div>
                    </div>
                    <div className="h-2 bg-muted rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${
                            Math.min(user?.stats?.totalLikes || 0, 10000) / 100
                          }%`,
                        }}
                      ></div>
                    </div>
                    <div className="flex justify-between mt-1 text-xs">
                      ...
                      <span>
                        {Math.floor((user?.stats?.totalLikes || 0) / 100)}%
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border p-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Received 100 likes across all posts
                        </p>
                      </div>
                    </div>
                    <div className="h-2 bg-muted rounded-full overflow-hidden">
                    ...
                    <div className="flex justify-between mt-1 text-xs">
                      <span>
                        {Math.min(user?.stats?.totalLikes || 0, 100)} / 100
                      </span>
                      <span>
                        {Math.min(
                          Math.floor(user?.stats?.totalLikes || 0),
                          100
                        )}
                        %
                      </span>
                  ...
                  <div className="rounded-lg border p-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Posted memes for 7 consecutive days
                        </p>
                      </div>
                    </div>
                    <div className="h-2 bg-muted rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${((user?.stats?.streak || 0) * 100) / 7}%`,
                        }}
                      ></div>
                    </div>
                    <div className="flex justify-between mt-1 text-xs">
                      ...
                      <span>
                        {Math.floor(((user?.stats?.streak || 0) * 100) / 7)}%
                      </span>
                    </div>
                  </div>
                </div>
